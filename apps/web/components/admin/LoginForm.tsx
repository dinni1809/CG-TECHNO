...
export default function LoginForm({ defaultCallbackUrl }: LoginFormProps) {
  ...
  async function handleLogin(e: React.FormEvent) {
    ...
    try {
      console.log('[AdminLogin] Triggering signIn() with credentials, callbackUrl:', defaultCallbackUrl);
      ...
      if (res?.error) {
        ...
        console.log('[AdminLogin] Sign in successful, redirecting to:', res?.url || defaultCallbackUrl);
        trackAdminLogin();
